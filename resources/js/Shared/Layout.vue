...
<template>
    ...
    <main class="min-h-screen space-y-10 bg-gradient-to-b from-gray-900 to-gray-600">
        <section class="flex flex-wrap justify-around items-center px-4 py-6 border-b border-main-blue gap-y-4 md:gap-y-0 md:justify-between md:px-16">
            <div class="flex justify-center items-center gap-x-3 md:gap-x-0">
                ...
                <div class="flex items-center space-x-8">
                    <div class="border-none border-main-blue md:px-6 md:border-r">
                        <h1 class="text-3xl text-main-blue font-poppins font-bold md:text-4xl">Bookster</h1>
                    </div>
                    <Nav />
                </div>
            </div>
            ...
            <div class="flex justify-center items-center gap-x-4">
                <span v-if="auth" class="text-main-orange text-sm text-center md:text-left font-poppins">Welcome back, {{ auth.user.username }}</span>
